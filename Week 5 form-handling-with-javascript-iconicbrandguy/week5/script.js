...
let text = 'Losotho';
console.log(text);
console.log(text.length);  // Length of a word  
...
// Array method
const beverages = ['Mango', 'Apple', 'Orange'];
let fruit = beverages.length;
console.log(fruit);

const beverage = ['Mango', ' Apple', ' Orange'];
let listOfFruit = beverage.toString();
console.log(listOfFruit);

// Join()
const bev = ['Mango', 'Apple', 'Orange'];
let listing = bev.join('-');
console.log(listing);